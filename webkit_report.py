...
#            command.extend(['--margin-top', str(webkit_header.margin_top).replace(',', '.')])
	#TODO: This is big mess. Fix me!
	if report_xml.model == 'stock.out.package':
            command.extend(['--page-height', '6.5in', '--page-width', '4in', '--disable-smart-shrinking', 
				'-d', '300', '-B', '0mm', '-T', '1mm', '-R', '0mm', '-L', '0mm'])
	else:
